...
### 4. 项目依赖
- **Spark**（[https://gitee.com/xunmeng2002/Spark](https://gitee.com/xunmeng2002/Spark)）：个人基础库，提供 Core、Serialization 等通用模块。需提前编译并放置于 `../Libs/Spark` 路径下（CMake 通过 `find_package(Spark REQUIRED PATHS "../Libs/Spark/x64-windows")` 查找）。

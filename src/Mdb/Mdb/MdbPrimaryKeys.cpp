...
namespace mdb
{
	...
	{
		Utility::Strcpy(t_CompareExchange.ExchangeID, ExchangeID);
	...
	{
		Utility::Strcpy(t_CompareProduct.ExchangeID, ExchangeID);
		Utility::Strcpy(t_CompareProduct.ProductID, ProductID);
	...
	Instrument* InstrumentPrimaryKey::Select(const ExchangeIDType& ExchangeID, const InstrumentIDType& InstrumentID)
	{
		...
		Utility::Strcpy(t_CompareInstrument.InstrumentID, InstrumentID);
	...
	{
		Utility::Strcpy(t_ComparePrimaryAccount.PrimaryAccountID, PrimaryAccountID);
	...
	{
		Utility::Strcpy(t_CompareAccount.AccountID, AccountID);
	...
	{
		Utility::Strcpy(t_CompareCapital.TradingDay, TradingDay);
		Utility::Strcpy(t_CompareCapital.AccountID, AccountID);
	...
	{
		Utility::Strcpy(t_ComparePosition.TradingDay, TradingDay);
		Utility::Strcpy(t_ComparePosition.AccountID, AccountID);
		Utility::Strcpy(t_ComparePosition.ExchangeID, ExchangeID);
		Utility::Strcpy(t_ComparePosition.InstrumentID, InstrumentID);
	...
	{
		Utility::Strcpy(t_ComparePositionDetail.TradingDay, TradingDay);
		Utility::Strcpy(t_ComparePositionDetail.AccountID, AccountID);
		Utility::Strcpy(t_ComparePositionDetail.ExchangeID, ExchangeID);
		Utility::Strcpy(t_ComparePositionDetail.InstrumentID, InstrumentID);
		t_ComparePositionDetail.PosiDirection = PosiDirection;
		Utility::Strcpy(t_ComparePositionDetail.OpenDate, OpenDate);
		Utility::Strcpy(t_ComparePositionDetail.TradeID, TradeID);
	...
	{
		Utility::Strcpy(t_CompareOrder.TradingDay, TradingDay);
		Utility::Strcpy(t_CompareOrder.AccountID, AccountID);
		Utility::Strcpy(t_CompareOrder.ExchangeID, ExchangeID);
		Utility::Strcpy(t_CompareOrder.InstrumentID, InstrumentID);
	...
	{
		Utility::Strcpy(t_CompareTrade.TradingDay, TradingDay);
		Utility::Strcpy(t_CompareTrade.ExchangeID, ExchangeID);
		Utility::Strcpy(t_CompareTrade.TradeID, TradeID);

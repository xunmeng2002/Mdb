...
constexpr const char* CreateSqliteDBTradingDayTableSqlString = "CREATE TABLE IF NOT EXISTS t_TradingDay(PK int, CurrTradingDay char(16), PreTradingDay char(16), PRIMARY KEY(PK));";
